...
function AdaarSadhya({root }) {
	...
	return (
		...
		>
			...
			<h3
				data-speed="1.2"
				class="parallax sticky translate-y-[50px] top-[10vh] text-center justify-center  text-[#696338] font-black md:text-[9rem] text-[3rem]"
			>
				Oru Adaar
			</h3>
			<h3
			...
			>
				ഓണത്തിനിടയിൽ പുട്ടുകച്ചവടം വേണ്ട
			</p>
			<button
				onClick={() =>
					root.scrollTo({ y: window.innerHeight, behaviour: "smooth" })
				}
				class="  mt-10  translate-y-[-80px]  border-2 border-green-400 text-white hover:bg-green-400 hover:scale-105 transition-transform hover:text-black w-fit h-fit px-16 py-2 text-[1.4rem] rounded-2xl"
			>
				Order My Sadhya
			</button>
		</div>
